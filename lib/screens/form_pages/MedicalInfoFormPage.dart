  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
        child: Column(children: [
          ...
          EditableChipField(title: 'Antécédents médicaux',
              onChanged: (value) {
                userForm.medicalHistory = value;
              },
              hintText: 'Boulimie, dents de sagesse...'),
          EditableChipField(title: 'Facteurs de risque',
              onChanged: (value) {
                userForm.riskFactors = value;
              },
              hintText: 'Tabagisme, alcoolisme...'),
          EditableChipField(title: 'Prises en charge médicales',
              onChanged: (value) {
                userForm.medicalCare = value;
              },
              hintText: 'Kinésithérapie, psychologue...'),
          EditableChipField(title: 'Traitements médicamenteux',
              onChanged: (value) {
