...
class PhysicalExerciseFormpage extends StatelessWidget {
  ...
  const PhysicalExerciseFormpage({super.key, required this.formKey});
    ...
    return SingleChildScrollView(
        child: Form(
            ...
            child: Column(children: [
              ...
              EditableChipField(
                title: 'Activité physique antérieure',
                onChanged: (value) {
                  userForm.previousPhysicalActivity = value;
                },
              ),
              EditableChipField(
                title: 'Activité physique actuelle',
                onChanged: (value) {
                  userForm.currentPhysicalActivity = value;
                },
              ),
              CustomDropdownButton(
                labelText: 'À quelle fréquence ? (par semaine)',
                width: 150,
                onChanged: (value) {
              ...
              CustomDropdownButton(
                labelText: 'Pendant quelle durée ? (en heures)',
                width: 150,
                onChanged: (value) {
              ...
              EditableChipField(
                  title: 'Difficultés pour pratiquer',
                  onChanged: (value) {
                    userForm.medicalCare = value;
                  },
                  hintText: 'Temps, douleurs, fatigue...'),
              CustomDropdownButton(
                labelText: 'Savez-vous vous allonger et vous relever ?',
                width: 150,
                onChanged: (value) {
                ...
                validator: (value) {
                  if (value == null) {
                    return 'Veuillez entrer si vous savez vous allonger et vous relever';
                  }
                  return null;
                },
              ),
              CustomDropdownButton(
                  labelText: 'Possédez-vous du matériel sportif ?',
                  width: 150,
                  onChanged: (value) {
                  ...
                  validator: (value) {
                    if (value == null) {
                      return 'Veuillez entrer si vous possédez du matériel sportif';
                    }
                    return null;
                  }),
              CustomInputField(
                labelText: 'Attentes sur le programme sportif',
                ...
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return 'Veuillez entrer vos attentes sur le programme sportif';
                  }
                  return null;
                },
              ),
